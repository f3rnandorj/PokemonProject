...
import { Pokemon, PokemonApi } from '@domain';

import { PokemonNameDataApi } from '../../../domain/Pokemon/pokemonTypes';

const mockedDataPokemonList: Pokemon[] = [
  {
    avatarURL:
    ...
    effectiveness:
      'Pokémons do tipo planta são fortes contra pokémons do tipo terrestre, pedra, água e são fracos contra pokémons do tipo inseto, fogo, voador, gelo, normal. Pokémons do tipo venenoso são fortes contra pokémons do tipo fada, planta e são fracos contra pokémons do tipo terrestre, psíquico.',
    height: 0.7,
    id: 1,
    name: 'bulbasaur',
    principalMove: 'poison-powder',
    types: ['grass', 'poison'],
    weight: 6.9,
  },
];

const mockedDataPokemonApi: PokemonApi = {
  abilities: [
    {
      ability: {
        name: 'overgrow',
...
const mockedPokemonNameDataApi: PageApi<PokemonNameDataApi> = {
  count: 1292,
  next: 'https://pokeapi.co/api/v2/pokemon?offset=20&limit=20',
  previous: null,
  results: pokemonNameDataApi,
};

export const mockedPokemonListData = {
  mockedDataPokemonList,
  mockedPokemonNameDataApi,
  mockedDataPokemonApi,
};
